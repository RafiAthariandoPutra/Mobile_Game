...
// Pages / Containers
var pagePlayArea = document.getElementById('pagePlayArea');
var pageGameMenu = document.getElementById('pageGameMenu');
var pageTutorial = document.getElementById('pageTutorial');
var pageLevelInfo = document.getElementById('pageLevelInfo');
var pagePauseMenu = document.getElementById('pagePauseMenu');
var pageLevelPassed = document.getElementById('pageLevelPassed');
...
var playAreaPageToggle = document.getElementById('playAreaPage-toggle');
var gameMenuPageToggle = document.getElementById('gameMenuPage-toggle');
var tutorialPageToggle = document.getElementById('tutorialPage-toggle');
var levelInfoPageToggle = document.getElementById('levelInfoPage-toggle');
var pauseMenuPageToggle = document.getElementById('pauseMenuPage-toggle');
var levelPassedPageToggle = document.getElementById('levelPassedPage-toggle');
...
for (var i = 0; i < pagesTogglesArray.length; i++) {
  pagesTogglesArray[i].onclick = function() {
    for (var i = 0; i < pagesTogglesArray.length; i++) {
...
var updateLevelsCount = function() { // Get number of levels
...
var audioPool = {
  sounds: [
    ...
    buttonTab = { sound: "chick", preload: true},
  ],
...
audioPool.addSounds(); // Add sounds in audio players
